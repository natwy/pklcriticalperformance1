...
<head>
    <meta charset="UTF-8">
    <title>Login - Critical Performance</title>
...
<body>
    ...
    <div class="card">
        <h2><i class="fas fa-user"></i> Masuk ke Akun Anda</h2>
    ...
    <script>
        // === LOGIKA TOMBOL MATA + EFEK PUTIH SAAT SHOW ===
        ...
        togglePassword.addEventListener('click', function() {
            ...
            // tambahkan efek warna putih saat "show"
            if (isPassword) {
                passwordInput.classList.add('showing');
            } else {
                passwordInput.classList.remove('showing');
            }
        });
    </script>
